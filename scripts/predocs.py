...
# Add "#!/usr/bin/python" on first line, to run with bash terminal
# azd auth login
# python.exe ./scripts/prepdocs.py './data/*' --storageaccount "mystorageaccount" --container "content" --searchservice "gptkb" --searchkey "gptkbkey" --index "gptkbindex" --formrecognizerservice "frkb" --formrecognizerkey "frkbkey" --tenantid "tenandid" -v
import os
import argparse
import glob
import html
